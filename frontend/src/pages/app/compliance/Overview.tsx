    ...
    <div className="grid grid-cols-1 gap-4">
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-[320px_minmax(0,1fr)]">
        ...
        <div className="grid grid-cols-2 content-start gap-3 sm:gap-4">
          <StatCard label="Valid" value={counts.Valid} tone="success" index={0} />
          <StatCard label="Expiring" value={counts.Expiring} tone="warning" index={1} hint="Within 60 days" />
          <StatCard label="Expired" value={counts.Expired} index={2} hint="Renew immediately" />
          <StatCard label="Missing" value={counts.Missing} index={3} hint="Not yet uploaded" />
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-[minmax(0,1fr)_380px]">
        ...
        <Section title="Upcoming expiries" description="Next 90 days">
          {upcoming.length ? (
            ...
            <EmptyState title="Nothing expiring soon" description="No documents expire in the next 90 days." />
          )}
        </Section>
      </div>
    </div>
